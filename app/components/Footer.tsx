...
export default function Footer() {
  const socialLinks = [
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/knbl_agency/',
      icon: (
    ...
    {
      name: 'Facebook',
      href: 'https://www.facebook.com/KanibalM',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'LinkedIn',
      href: 'https://www.linkedin.com/company/knblagency/posts/?feedView=all',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'YouTube',
      href: 'https://www.youtube.com/@kanibalmedia5486',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <footer data-theme="dark" className="text-white px-10 md:px-24 pt-16 pb-8 rounded-t-[32px]">
