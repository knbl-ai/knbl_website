...
const projects: Project[] = [
  ...
  { id: 7, image: '/images/projects/project-1.webp', name: 'H&O Summer', alt: 'H&O Summer', delay: 0.6 },
  { id: 8, image: '/images/projects/project-2.webp', name: 'Electra Pro', alt: 'Electra Pro', delay: 0.7 },
  { id: 9, image: '/images/projects/project-3.webp', name: 'Roladin Holiday', alt: 'Roladin Holiday', delay: 0.8 },
  { id: 10, image: '/images/projects/project-4.webp', name: 'Eden Fresh', alt: 'Eden Fresh', delay: 0.9 },
  { id: 11, image: '/images/projects/project-5.webp', name: 'Rafael Tech', alt: 'Rafael Tech', delay: 1.0 },
  { id: 12, image: '/images/projects/project-6.webp', name: 'On Active', alt: 'On Active', delay: 1.1 },
];
