        ...
        <main className="min-h-screen bg-white">
            ...
            <section className="pt-32 md:pt-48 pb-0 px-6 md:px-[120px]">
                <div className="max-w-7xl mx-auto">
                    ...
                    >
                        <h1 className="text-4xl md:text-[56px] font-medium text-black leading-[1.1] tracking-[-0.04em] max-w-[800px]">
                            The Brands We&apos;ve <span className="text-primary-600">Grown.</span>
                        </h1>
                    </motion.div>
                </div>
            </section>

            <section className="pt-12 md:pt-16 pb-24 md:pb-44 px-6 md:px-[120px]">
                <div className="max-w-7xl mx-auto">
                    {/* Projects Grid - Premium Bento Alignment */}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
                            ...
                            <div className="md:col-span-8 flex flex-col gap-4">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <ProjectCard project={projects[2]} height="h-[250px] md:h-[300px]" />
                                    <ProjectCard project={projects[3]} height="h-[250px] md:h-[300px]" />
                                </div>
                            </div>
                        </div>

                        {/* ROW 2: Balanced Wide Block (Projects 4, 8) */}
                        <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
                            <div className="md:col-span-4">
                                <ProjectCard project={projects[4]} height="h-[300px] md:h-[350px]" />
                            </div>
                            <div className="md:col-span-8">
                                <ProjectCard project={projects[8]} height="h-[300px] md:h-[350px]" />
                            </div>
                        </div>

                        {/* ROW 3: Reversed Bento Block (Projects 5-7, 9) */}
                        <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
                            <div className="md:col-span-8 flex flex-col gap-4">
                                <ProjectCard project={projects[6]} height="h-[250px] md:h-[300px]" />
                                <div className="grid grid-cols-2 gap-4">
                                    <ProjectCard project={projects[7]} height="h-[250px] md:h-[200px]" />
                                    <ProjectCard project={projects[9]} height="h-[250px] md:h-[200px]" />
                                </div>
                            </div>
                            <div className="md:col-span-4">
                                <ProjectCard project={projects[5]} height="h-[400px] md:h-[516px]" />
                            </div>
                        </div>

                        {/* ROW 4: Extended Bento Showcase (Projects 10-13) */}
                        <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
                            <div className="md:col-span-8 flex flex-col gap-4">
                                <ProjectCard project={projects[10]} height="h-[300px] md:h-[400px]" />
                                <div className="grid grid-cols-2 gap-4">
                                    <ProjectCard project={projects[11]} height="h-[250px] md:h-[300px]" />
                                    <ProjectCard project={projects[12]} height="h-[250px] md:h-[300px]" />
                                </div>
                            </div>
                            <div className="md:col-span-4">
                                <ProjectCard project={projects[13]} height="h-[400px] md:h-[716px]" />
                            </div>
                        </div>
                    </div>
                </div>
